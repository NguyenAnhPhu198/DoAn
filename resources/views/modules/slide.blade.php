...
<div class="container hidden-xs">
    <div class="fluid_container">            
      <div class="camera_violet_skin" id="camera_wrap_1">
        <div data-thumb="{!!url('public/images/slides/thumbs/ảnh_mô_tả.png')!!}" data-src="{!!url('public/images/slides/thumbs/ảnh_mô_tả.png')!!}">
            <div class="camera_caption fadeFromBottom">
                Sắm Apple giá tốt, Du lịch châu âu. <em>Event mua hàng Apple Tại Kim An</em>
            </div>
        </div>
        <div data-thumb="{!!url('public/images/slides/thumbs/qc2.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc2.png')!!}">
            <div class="camera_caption fadeFromBottom">
                Sony trả góp 0%, có cỏ hội trúng Tivi 4K <em> Dành cho sản phẩm sony tại Kim An  </em>
            </div>
        </div>
        <div data-thumb="{!!url('public/images/slides/thumbs/qc3.png')!!}" data-src="{!!url('public/images/slides/thumbs/qc3.png')!!}">
            <div class="camera_caption fadeFromBottom">
                Galaxy J7 Prime - mua online thêm quà, <em> Dành cho Galaxy J7 Prime Tại Kim An </em>
            </div>
        </div>
        ...
        <div data-thumb="{!!url('public/images/slides/thumbs/qc6.jpg')!!}" data-src="{!!url('public/images/slides/thumbs/qc6.jpg')!!}">
            <div class="camera_caption fadeFromBottom">
               Đồng hành cùng lễ hội Hàn Quốc   <em> Khuyễn mãi tại thiên đường công nghệ Kim An</em>
            </div>
        </div>
      </div><!-- #camera_wrap_1 -->       
    </div><!-- .fluid_container -->   
